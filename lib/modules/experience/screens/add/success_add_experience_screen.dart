...
class SuccessAddExperienceScreen extends StatelessWidget {
  const SuccessAddExperienceScreen({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
                "Harap tunggu tim kami melakukan verifikasi terkait dengan Experience yang anda tawarkan ",
